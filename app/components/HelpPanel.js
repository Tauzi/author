...
Author 是一款面向小说创作者的 **AI 辅助写作平台**，集成正文补完、设定集管理、上下文感知等专业功能，为你打造沉浸式创作体验。
...
### 第三步：AI 辅助
- **内联 AI**：按 **Ctrl+A** 一键全选当前文章并唤起 AI，直接在编辑器中补完正文
...
### 唤起方式
按下 **Ctrl+A**（Mac: **⌘+A**）即可全选当前文章，并在页面中央弹出 AI 面板。
...
### 使用步骤
1. 将光标放在要补完正文的位置，或选中要修改的文字
2. 按 **Ctrl+A** 打开 AI 面板
3. 选择所需模式
4. （可选）在输入框中补充指示，如"补完这一段并自然收束"
5. 按 **Enter** 或点击 **✦ 生成** 开始
...
### ⚠️ AI 功能的隐私须知
使用 AI 功能时（完成正文、改写、对话等），你的 **API Key** 和 **发送给 AI 的文字内容** 会经过部署者的服务器转发给 AI 供应商。
